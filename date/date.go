...
import (
	...
	"github.com/raceresult/go-model/date/gregorian"
	"github.com/raceresult/go-model/date/period"
)
...
func Min() Date {
	return Date{day: PeriodOfDays(math.MinInt32), isDefined: true}
}

// Max returns the largest representable date.
func Max() Date {
	return Date{day: PeriodOfDays(math.MaxInt32), isDefined: true}
}
